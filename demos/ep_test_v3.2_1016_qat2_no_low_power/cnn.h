...
/*
 * This header file was automatically @generated for the ep_test_v3.2_1016_qat2_no_low_power network from a template.
...
/*
  ...
  RESOURCE USAGE
  Weight memory: 1,500 bytes out of 442,368 bytes total (0.3%)
  Bias memory:   32 bytes out of 2,048 bytes total (1.6%)
*/
