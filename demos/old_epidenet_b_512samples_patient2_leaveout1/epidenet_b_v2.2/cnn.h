...
/*
 * This header file was automatically @generated for the epidenet_b_v2.2 network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 166,628 ops (159,536 macc; 6,868 comp; 224 add; 0 mul; 0 bitwise)
    ...
    Layer 5 (block5_avgpool1d): 224 ops (0 macc; 0 comp; 224 add; 0 mul; 0 bitwise)
    Layer 6 (block6_dense): 32 ops (32 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 2,672 bytes out of 442,368 bytes total (0.6%)
  Bias memory:   36 bytes out of 2,048 bytes total (1.8%)
*/
