...
/*
 * This header file was automatically @generated for the ep_test_v3.2_768_qat1_no_low_power network from a template.
...
/*
  ...
  RESOURCE USAGE
  Weight memory: 750 bytes out of 442,368 bytes total (0.2%)
