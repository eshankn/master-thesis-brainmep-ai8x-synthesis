...
/*
 * This header file was automatically @generated for the epidenet_b_v3.2_1016_qat2 network from a template.
...
/*
  ...
  RESOURCE USAGE
  Weight memory: 3,024 bytes out of 442,368 bytes total (0.7%)
